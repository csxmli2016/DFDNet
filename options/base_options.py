...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--loadSize', type=int, default=550, help='scale images to this size')
        ...
        parser.add_argument('--which_model_netG', type=str, default='encoderVggDecoderResNet', help='selects model to use for netG')
